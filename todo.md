...
- [ ] **7.6 Difficulty, Win/Loss & New Game Setup** — plan only.
  - [ ] What losing actually means: is a fully-overrun settlement a permanent loss of that territory (matches the persistent-map, region-based Discontent/ZoC model well), full campaign failure, or something in between? Needs a decision before Phase 5's combat can call it.
